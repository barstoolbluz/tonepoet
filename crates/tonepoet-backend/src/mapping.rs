    ...
    let codec = match depth {
        ...
        320 | 33 => {
            ...
            if format.supports_float() {
                ...
                log::warn!(
                    "Format {} doesn't support float audio, using 32-bit integer",
                    format.extension()
                );
                if big_endian {
                    "pcm_s32be"
