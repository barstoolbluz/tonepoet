...
pub fn draw_output_options_pane(
    ...
    let dest_row = bordered_line(border_color, w, vec![
    ...
    let folder_row = bordered_line(border_color, w, vec![
    ...
    let file_row = bordered_line(border_color, w, vec![
    ...
    let merge_row = pill_row(
        border_color, w, "merge      ", "",
        &render_pill_spans(&opts.merge, is_merge_focused),
        is_merge_focused,
    );

    // Estimated size
    let est_row = bordered_line(border_color, w, vec![
