...
EXTERNAL_LAUNCH_INVENTORY = [
    ...
    ("src/tui/archive_listing.rs", "list_archive_with_options_using_binary", 1, "read_only_probe"),
    ("src/tui/archive_listing.rs", "test_archive_entry_password_using_binary", 1, "read_only_probe"),
